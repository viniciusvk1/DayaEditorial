...
export const authors = [
  ...
  { id: 3, name: 'Ary Abrantes', photo: '/authors/Ary/aryabrantes.jpg', genre: '', books: 4 },
  ...
  { id: 79, name: 'Cibele Bernardo', photo: '/authors/CibeleBernardo/Foto Cibele.jpg', genre: '', books: 1 },
  { id: 7, name: 'Clauni Barbosa', photo: '/authors/Clauni/clauni.jpg', genre: '', books: 2 },
  ...
  { id: 11, name: 'Dirce Biscuola de Pinho', photo: '/authors/Dirce/dirce_pinho_p.jpg', genre: '', books: 2 },
  { id: 12, name: 'Edmur De Lucca', photo: '/authors/Edmur/edmur_lucca_p.jpg', genre: '', books: 5 },
  ...
  { id: 16, name: 'Eliseu Labigalini', photo: '/authors/Eliseu/eliseu.jpg', genre: '', books: 3 },
  ...
  { id: 19, name: 'Érico da Fonseca', photo: '/authors/Erico/erico.jpg', genre: '', books: 2 },
  ...
  { id: 80, name: 'Fernando Fabião', photo: '/authors/FernandoFabiao/Foto Fernando Fabiao.jpg', genre: '', books: 1 },
  ...
  { id: 81, name: 'Jesualdo Costa', photo: '/authors/JesualdoCosta/Foto Jesualdo.jpg', genre: '', books: 2 },
  ...
  { id: 31, name: 'Jonas Barros', photo: '/authors/Jonasbarros/jonas-barros_p.jpg', genre: '', books: 3 },
  ...
  { id: 35, name: 'Katia Bueno', photo: '/authors/Katia/katia.jpg', genre: '', books: 2 },
  { id: 36, name: 'Kátia Regina de Oliveira', photo: '/authors/Katiaregina/katia-regina_p.jpg', genre: '', books: 1 },
  { id: 37, name: 'Lauriano dos Santos', photo: '/authors/LaurianoSantos/lauriano-santos_p.jpg', genre: '', books: 10 },
  ...
  { id: 82, name: 'Maria Eduarda', photo: '/authors/MariaEduarda/Foto Maria Eduarda.jpg', genre: '', books: 1 },
  { id: 83, name: 'Maria Elisabete Perez Simoni', photo: '/authors/MariaElisabete/Maria Elisabete Perez Simoni.jpg', genre: '', books: 1 },
  ...
  { id: 52, name: 'Marzio Labigalini', photo: '/authors/Marzio/marzio.jpg', genre: '', books: 3 },
  { id: 84, name: 'Mauricélia', photo: '/authors/Mauricelia/Foto Mauricelia.jpeg', genre: '', books: 1 },
  ...
  { id: 85, name: 'Ronel Barbosa', photo: '/authors/RonelBarbosa/Foto Ronel.jpg', genre: '', books: 3 },
  ...
  { id: 66, name: 'Sá de Carvalho', photo: '/authors/Sadecarvalho/sa-de-carvalho_p.jpg', genre: '', books: 7 },
  ...
  { id: 70, name: 'Sibeles Maria De Masi', photo: '/authors/Sibeles/Sibeles_p.jpg', genre: '', books: 4 },
  ...
  { id: 73, name: 'Valderez Escobar', photo: '/authors/Valderez/valderez-escobar_p.jpg', genre: '', books: 11 },
  { id: 86, name: 'Valter Farid', photo: '/authors/ValterFarid/Foto Valter.jpg', genre: '', books: 3 },
