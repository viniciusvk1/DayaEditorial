...
const authorData = {
  ...
  10: {
    name: 'Dilo Guasque',
    photo: 'Dilo Mestrinho Guasque nasceu em Manaus – AM, no dia 8 de janeiro de 1932. Antes de completar 1 ano de idade, sua família mudou-se para o Rio de Janeiro,onde Dilo se formou em Administração de Empresas, constituiu família e viveu até se aposentar, em 1984. A partir de então, passou a morar na Ilha da Gipóia, em Angra dos Reis – RJ. Atualmente, vive no Rio de Janeiro. Formado também em Belas Artes, é escritor e artista plástico bastante premiado nas duas modalidades artísticas. É membro do Ateneu Angrense de Letras e Artes. Tem vários livros publicados.',
    bio: '',
    books: [
